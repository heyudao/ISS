...
svc_w2v = Pipeline([("word2vec vectorizer", MeanEmbeddingVectorizer(w2v)), ("svc", SVC(kernel="linear",C=10.0))])


# SVM + GLOVE vectors + MeanEmbedding
svc_glove_small = Pipeline([("glove vectorizer", MeanEmbeddingVectorizer(glove_small)), ("svc", SVC(kernel="linear",C=10.0))])
