...
num_val = 7178
batch_size = 64
num_epoch = 2 # change this for epoch
...
# emotions will be displayed on your face from the saved image
elif mode == "display_image":
